...
public:
	...
	// individual shapes
	const ShapeId GetNextShapeId()
	{
		return ++mCurrentId;
	}
	ShapeId GetCurrentFocus()
	{
		return mCurrentFocus;
	}
	void SetCurrentFocus(ShapeId id)
	{
		mCurrentFocus = id;
	}

	// points
	PointTable::const_iterator GetPointBegin() const
	{
		return mPoints.begin();
	}
	PointTable::const_iterator GetPointEnd() const
	{
		return mPoints.end();
	}
	...
	// lines
	LineTable::const_iterator GetLineBegin() const
	{
		return mLines.begin();
	}
	LineTable::const_iterator GetLineEnd() const
	{
		return mLines.end();
	}
	...
	// face
	FaceTable::const_iterator GetFaceBegin() const
	{
		return mFaces.begin();
	}
	FaceTable::const_iterator GetFaceEnd() const
	{
		return mFaces.end();
	}
